...
Print 'Inicio de creacion de tablas'
	...
	/*-4- Creo tabla Tipo de Habitaciones*/
	...
	/*-6- Creo tabla Historial de cierres por hotel*/
	...
	/*-7- Creo tabla Regimen de estadia*/
	...
	/*-8- Creo tabla Regimen por hotel*/
	...
	/*-10- Creo tabla Usuarios por hotel*/
	...
	/*-16- Creo tabla Consumible por estadia*/
	...
	/*-17- Creo tabla Estadia por Persona*/
	...
	/*-18- Creo tabla Habitaciones por Reserva*/
...
Print 'Inicio de migracion de datos'
	...
	INSERT INTO [CUATROGDD2018].[Usuario_X_Rol] (id_usuario,id_rol) VALUES (1,1);
	INSERT INTO [CUATROGDD2018].[Usuario_X_Rol] (id_usuario,id_rol) VALUES (1,3);
	INSERT INTO [CUATROGDD2018].[Usuario_X_Rol] (id_usuario,id_rol) VALUES (3,4);
	...
	OPEN insert_cursor
	FETCH NEXT FROM insert_cursor INTO @dirHotel,@nroCalle, @numHab, @habPiso, @habFrente, @tipoHab 
