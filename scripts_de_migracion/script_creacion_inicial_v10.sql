...
/*BORRADO DE ENTIDADES*/
	IF OBJECT_ID('CUATROGDD2018.Usuario_X_Hotel_X_Rol') IS NOT NULL
		DROP TABLE [CUATROGDD2018].[Usuario_X_Hotel_X_Rol];
	IF OBJECT_ID('CUATROGDD2018.Consumible_X_Estadia') IS NOT NULL
		DROP TABLE [CUATROGDD2018].[Consumible_X_Estadia];
	IF OBJECT_ID('CUATROGDD2018.Estadia_X_Persona') IS NOT NULL
		DROP TABLE [CUATROGDD2018].[Estadia_X_Persona];
	IF OBJECT_ID('CUATROGDD2018.Habitacion_X_Reserva') IS NOT NULL
		DROP TABLE [CUATROGDD2018].[Habitacion_X_Reserva];
	IF OBJECT_ID('CUATROGDD2018.Regimen_X_Hotel') IS NOT NULL
		DROP TABLE [CUATROGDD2018].[Regimen_X_Hotel];
	IF OBJECT_ID('CUATROGDD2018.Usuario_X_Hotel_X_Rol') IS NOT NULL
		DROP TABLE [CUATROGDD2018].[Usuario_X_Hotel_X_Rol];
	IF OBJECT_ID('CUATROGDD2018.Consumibles') IS NOT NULL
		DROP TABLE [CUATROGDD2018].[Consumibles];
	IF OBJECT_ID('CUATROGDD2018.Historial_Cierres') IS NOT NULL
		DROP TABLE [CUATROGDD2018].[Historial_Cierres];
	IF OBJECT_ID('CUATROGDD2018.Facturas') IS NOT NULL
		DROP TABLE [CUATROGDD2018].[Facturas];
	IF OBJECT_ID('CUATROGDD2018.Forma_de_Pago') IS NOT NULL
		DROP TABLE [CUATROGDD2018].[Forma_de_Pago];
	IF OBJECT_ID('CUATROGDD2018.Estadias') IS NOT NULL
		DROP TABLE [CUATROGDD2018].[Estadias];
	IF OBJECT_ID('CUATROGDD2018.Reservas_Canceladas') IS NOT NULL
		DROP TABLE [CUATROGDD2018].[Reservas_Canceladas];
	IF OBJECT_ID('CUATROGDD2018.Reservas') IS NOT NULL
		DROP TABLE [CUATROGDD2018].[Reservas];
	IF OBJECT_ID('CUATROGDD2018.Estados_Reservas') IS NOT NULL
		DROP TABLE [CUATROGDD2018].[Estados_Reservas];
	IF OBJECT_ID('CUATROGDD2018.Habitaciones') IS NOT NULL
		DROP TABLE [CUATROGDD2018].[Habitaciones];
	IF OBJECT_ID('CUATROGDD2018.Tipo_Habitacion') IS NOT NULL
		DROP TABLE [CUATROGDD2018].[Tipo_Habitacion];
	IF OBJECT_ID('CUATROGDD2018.Usuario_X_Hotel') IS NOT NULL
		DROP TABLE [CUATROGDD2018].[Usuario_X_Hotel];
	IF OBJECT_ID('CUATROGDD2018.Hoteles') IS NOT NULL
		DROP TABLE [CUATROGDD2018].[Hoteles];
	IF OBJECT_ID('CUATROGDD2018.Usuario_X_Rol') IS NOT NULL
		DROP TABLE [CUATROGDD2018].[Usuario_X_Rol];
	IF OBJECT_ID('CUATROGDD2018.Regimenes_Estadia') IS NOT NULL
		DROP TABLE [CUATROGDD2018].[Regimenes_Estadia];
	IF OBJECT_ID('CUATROGDD2018.Funcionalidad_X_Rol') IS NOT NULL
		DROP TABLE [CUATROGDD2018].[Funcionalidad_X_Rol];
	IF OBJECT_ID('CUATROGDD2018.Funcionalidades') IS NOT NULL
		DROP TABLE [CUATROGDD2018].[Funcionalidades];
	IF OBJECT_ID('CUATROGDD2018.Roles') IS NOT NULL
		DROP TABLE [CUATROGDD2018].[Roles];
	IF OBJECT_ID('CUATROGDD2018.Personas') IS NOT NULL
		DROP TABLE [CUATROGDD2018].[Personas];
	IF OBJECT_ID('CUATROGDD2018.Usuarios') IS NOT NULL
...
Print 'Creacion de tablas'
	...
	/*-5- Creo tabla Tipo de Habitaciones*/
	...
	/*-7- Creo tabla Historial de cierres por hotel*/
	...
	/*-9- Creo tabla Regimen por hotel*/
	...
	/*-11- Creo tabla Usuario_X_Hotel_X_Rol*/
	...
	CREATE TABLE [CUATROGDD2018].[Reservas] (
		...
		FOREIGN KEY (id_regimen) REFERENCES [CUATROGDD2018].[Regimenes_Estadia] (id_regimen),
		FOREIGN KEY (id_usuario_reserva) REFERENCES [CUATROGDD2018].[Usuarios] (id_usuario),
		FOREIGN KEY (id_estado_reserva) REFERENCES [CUATROGDD2018].[Estados_Reservas] (id_estado_reserva)
	);

	/*-16- Creo tabla Estadias*/
	...
	/*-17- Creo tabla Consumible por estadia*/
	...
	/*-18- Creo tabla Estadia por Persona*/
	...
	/*-19- Creo tabla Habitaciones por Reserva*/
	...
	/*-20- Creo tabla Forma_de_Pago*/
	CREATE TABLE [CUATROGDD2018].[Forma_de_Pago](
		id_forma_depago int identity(1,1) not null PRIMARY KEY,
		descripcion varchar(30) not null,
		habilitado bit not null default('True')
		
	);
	
	/*-21- Creo tabla Facturas*/
	CREATE TABLE [CUATROGDD2018].[Facturas](	
		...
		foreign key (id_estadia) references [CUATROGDD2018].[Estadias] (id_estadia),
		foreign key (id_persona) references [CUATROGDD2018].[Personas] (id_persona),
		foreign key (id_forma_depago) references [CUATROGDD2018].[Forma_de_Pago] (id_forma_depago)
		);

	/*-22- Creo tabla Reservas canceladas*/
	CREATE TABLE [CUATROGDD2018].[Reservas_Canceladas](	
		id_reserva int not null,
		id_usuario int not null,
		fecha datetime,
		motivo varchar(max),
...
/*										MIGRACION															*/
/*##########################################################################################################*/
Print 'Inicio de migracion de datos y carga de datos iniciales'
	/*Inserto Formas de pago*/
	INSERT INTO [CUATROGDD2018].[Forma_de_Pago](descripcion)
	VALUES ('Efectivo');
	INSERT INTO [CUATROGDD2018].[Forma_de_Pago](descripcion)
	...
	SELECT DISTINCT  Habitacion_Tipo_Codigo
					,RTRIM(Habitacion_Tipo_Descripcion) AS Habitacion_Tipo_Descripcion
					,Habitacion_Tipo_Porcentual
					,CASE WHEN RTRIM(Habitacion_Tipo_Descripcion)='Base Simple' THEN 1
						  WHEN RTRIM(Habitacion_Tipo_Descripcion)='Base Doble' THEN 2
						  WHEN RTRIM(Habitacion_Tipo_Descripcion)='Base Triple' THEN 3
						  WHEN RTRIM(Habitacion_Tipo_Descripcion)='Base Cuadruple' THEN 4
						  WHEN RTRIM(Habitacion_Tipo_Descripcion)='King' THEN 5
					END AS cant_huespedes 
	...
	SELECT DISTINCT 
				RTRIM(Hotel_Ciudad)+' - '+RTRIM(Hotel_Calle) AS NOMBRE
				,RTRIM(Hotel_Nro_Calle) AS Hotel_Nro_Calle
				,RTRIM(Hotel_Ciudad) AS Hotel_Ciudad
				,RTRIM(Hotel_Calle) AS Hotel_Calle
				,Hotel_CantEstrella
	...
	DECLARE insert_cursor2 CURSOR FOR 
		SELECT RTRIM(Hotel_Calle) AS Hotel_Calle
			  ,Hotel_Nro_Calle
			  ,Habitacion_Numero
			  ,Habitacion_Piso
			  ,Habitacion_Frente
	...
	/*Insertar Regimen de estadia*/
	INSERT INTO [CUATROGDD2018].[Regimenes_Estadia](
				descripcion
				,precio_base)
	SELECT DISTINCT RTRIM(Regimen_Descripcion) AS Regimen_Descripcion
					,Regimen_Precio
		FROM [gd_esquema].[Maestra]
		ORDER BY Regimen_Descripcion
	GO
	
	/*Insertar Regimen por hotel*/
	DECLARE @nroCalle numeric(18,0)
			,@descReg varchar(255)
			,@codReg int
			,@codHotel int
	...
	DECLARE insert_cursor CURSOR FOR 
		SELECT Hotel_Calle
			  ,Hotel_Nro_Calle
			  ,RTRIM(Regimen_Descripcion) AS Regimen_Descripcion
		FROM [gd_esquema].[Maestra]
		GROUP BY Hotel_Calle
				,Hotel_Nro_Calle
				,RTRIM(Regimen_Descripcion)
	...
	SELECT DISTINCT 
				Consumible_Codigo
				,RTRIM(Consumible_Descripcion) AS Consumible_Descripcion
				,Consumible_Precio
	FROM [gd_esquema].[Maestra]
	...
	with clientes as(
	  SELECT Cliente_Pasaporte_Nro as nro_documento
				...
				,RTRIM(Cliente_Nombre) as nombre
				,RTRIM(Cliente_Apellido) as apellido
				,Cliente_Nacionalidad as nacionalidad
				,Cliente_Fecha_Nac as fecha_nac
				,RTRIM(Cliente_Dom_Calle) as calle
	  ...
	  GROUP BY	Cliente_Pasaporte_Nro
				,Cliente_Mail
				,RTRIM(Cliente_Nombre)
				,RTRIM(Cliente_Apellido)
				,Cliente_Nacionalidad
				,RTRIM(Cliente_Dom_Calle)
				,Cliente_Nro_Calle
				,Cliente_Piso
				,Cliente_Depto
				,Cliente_Fecha_Nac
	...
	SELECT Reserva_Codigo as id_reserva
			...
			,CASE WHEN Reserva_Fecha_Inicio<GETDATE() THEN 6 --Reserva efectivizada
				  WHEN Reserva_Fecha_Inicio>GETDATE() THEN 1 --Reserva correcta
				  ELSE 7 --Reserva en curso
	...
	select hab.id_habitacion
		  ,hab.[nro_habitacion] as habNumero
		  ,hab.piso as habPiso
		  ,ho.nro_calle as hotelCalle
	...
	/*Insertar Consumible por estadia*/
	...
	IF OBJECT_ID('CUATROGDD2018.Fn_DarPuntos') IS NOT NULL
		DROP FUNCTION [CUATROGDD2018].[Fn_DarPuntos]
	GO
	CREATE FUNCTION [CUATROGDD2018].[Fn_DarPuntos] (@porcentual numeric(18,2),@precioRegimen numeric(18,2),@consumibles numeric(18,2),@noches int)
	RETURNS int
	AS BEGIN
